...
public class PermissionUtils {
    ...
    /**
     * The constant REQUEST_PERMISSION_MULTIPLE.
     */
    public static final int REQUEST_PERMISSION_MULTIPLE = 0;
    /**
     * The constant REQUEST_PERMISSION_CAMERA.
     */
    public static final int REQUEST_PERMISSION_CAMERA = 1;
    /**
     * The constant REQUEST_PERMISSION_LOCATION.
     */
    public static final int REQUEST_PERMISSION_LOCATION = 2;
    /**
     * The constant REQUEST_WRITE_EXTERNAL.
     */
    public static final int REQUEST_WRITE_EXTERNAL = 3;

    /**
     * Check and request permissions boolean.
     *
    ...
    /**
     * Request write external permission.
     *
     * @param activity the activity
     */
