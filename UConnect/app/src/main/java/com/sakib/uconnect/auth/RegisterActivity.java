...
import com.sakib.uconnect.ProfileActivity;
import com.sakib.uconnect.R;
import com.sakib.uconnect.model.User;
import com.sakib.uconnect.utils.SessionManager;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    private String uploadedUri="",name="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editImage = findViewById(R.id.reg_edit_image);
        txtInputLayoutName = findViewById(R.id.reg_txt_il_name);
        regButton = findViewById(R.id.reg_btn_register);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (user != null) {
                    if(user.getName()!=null){
                        txtInputLayoutName.getEditText().setText("");
                    }
                    else{
            ...
            storageTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if(task.isSuccessful()){
                        ...
                        if (downloadUri != null) {
                            uploadedUri = downloadUri.toString();
                            Log.d(TAG, "onComplete: "+uploadedUri);
/*                            reference = FirebaseDatabase.getInstance().getReference("Users").child(firebaseUser.getUid());
                            HashMap<String,Object> hashMap = new HashMap<>();
                            hashMap.put("imageUrl",""+uploadedUri);
                            Log.d(TAG, "onComplete: "+uploadedUri);
    ...
    private void  registerUser(){
        ...
        if (firebaseUser != null) {
            ...
            name = txtInputLayoutName.getEditText().getText().toString();
            if(name.isEmpty()){
                name="default";
            }
            ...
            reference.setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if (task.isSuccessful()) {
                        ...
                        session.createLoginSession(finalUserId,mobileNumber,name);
